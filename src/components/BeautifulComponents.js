    ...
    <div className='h-auto w-screen'>
        <section className='w-[90%] lg:w-[75%] flex gap-32 h-full m-auto pt-44 pb-20 flex-col lg:flex-row'>
            ...
            <div className=' w-full lg:w-[50%] h-full'>
                ...
                <button className='bg-slate-200 p-2 px-4 ml-10 mt-10'>Learn More</button>
            </div>
        </section>


        <section className='w-[90%] lg:w-[75%] h-full m-auto pt-44 pb-10 flex gap-20 lg:gap-64 flex-col lg:flex-row'>
            <div>
            ...
            <div>
                <img src={WOMEN} className='h-[30rem] lg:h-[45rem] w-[25rem] lg:w-[36rem] relative bottom-20' />
            </div>
        </section>
